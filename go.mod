...
require (
	github.cbhq.net/infra/config-service v0.3.0
...
require (
	...
	github.cbhq.net/engineering/bugsnag-go v1.5.3-cb1 // indirect
	github.cbhq.net/engineering/cb-service_auth v1.30.1 // indirect
	github.cbhq.net/engineering/csf v1.40.4 // indirect
	github.cbhq.net/infra/darwin-aws-x509-fix v0.0.0-20220818191225-c561de57f640 // indirect
	github.cbhq.net/infra/key-automation v0.0.0-20220805194826-37bc83eedce9 // indirect
	github.cbhq.net/infra/rpcutility v0.8.1 // indirect
	...
	github.com/awslabs/aws-lambda-go-api-proxy v0.4.0 // indirect
