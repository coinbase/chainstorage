...
type optimismParserTestSuite struct {
	suite.Suite
...
func TestOptimismParserTestSuite(t *testing.T) {
	suite.Run(t, new(optimismParserTestSuite))
}

func (s *optimismParserTestSuite) SetupTest() {
...
func (s *optimismParserTestSuite) TearDownTest() {
	s.testapp.Close()
	s.controller.Finish()
}

func (s *optimismParserTestSuite) TestParseOptimismBlock() {
