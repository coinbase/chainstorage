...
var _ NativeParser = (*bitcoinNativeParserImpl)(nil)
...
func NewBitcoinNativeParser(params ParserParams, opts ...ParserFactoryOption) (NativeParser, error) {
	v := validator.New()
...
func (o *BitcoinTransactionOutput) ToApiBitcoinTransactionOutput() (*api.BitcoinTransactionOutput, error) {
	...
	return &api.BitcoinTransactionOutput{
		Value:           uint64(value),
		Index:           o.N.Value(),
		ScriptPublicKey: o.ScriptPubKey.ToApiBitcoinScriptPublicKey(),
	}, nil
}

func (k *BitcoinScriptPubKey) ToApiBitcoinScriptPublicKey() *api.BitcoinScriptPublicKey {
	if k == nil {
		return nil
	}
	...
	return &api.BitcoinScriptPublicKey{
